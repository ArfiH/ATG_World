...
const Card = (props) => {
  return (
    <>
      <div
        className="d-flex flex-column border border-1 rounded-2 mb-3"
        style={{
          maxWidth: 692,
      ...
      >
        <img src={props.postImgSrc} alt="Nature" className="imagePost" />
        <div className="p-4">
          <h3 className="d-flex">{props.postHead}</h3>
          <div className="d-flex gap-6 justify-content-between">
            <h4>{props.postSubject}</h4>
          ...
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center gap-2">
              <img
                ...
                alt="Profile"
                src={props.postAvatar}
                width={48}
                height={48}
              />
              <div className="d-flex flex-column">
                <div className="text-wrapper">{props.postAuthor}</div>
